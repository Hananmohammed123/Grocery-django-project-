...
(function ($) { 
  ...
  var opts = $.extend({}, $.fn.picZoomer.defaults, options), 
        ...
        $picBD = $('<div class="picZoomer-pic-wp"></div>') 
          ...
          .appendTo($this), 
        $pic = $this.children("img").addClass("picZoomerpic").appendTo($picBD), 
        $cursor = $( 
          '<div class="picZoomer-cursor"><i class="f-is picZoomCursorico"></i></div>' 
        ).appendTo($picBD), 
        cursorSizeHalf = { w: $cursor.width() / 2, h: $cursor.height() / 2 }, 
        $zoomWP = $( 
          '<div class="picZoomer-zoom-wp"><img src="" alt="" class="picZoomerzoom-pic"></div>' 
        ).appendTo($this), 
